...
open class URLSessionRequestBuilder<T>: RequestBuilder<T> {
    ...
    override open func execute(_ apiResponseQueue: DispatchQueue = AggregateAPIClient.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, Error>) -> Void) {
        ...
        case is URL.Type:
            do {
                ...
                if let headerFileName = getFileName(fromContentDisposition: httpResponse.allHeaderFields["Content-Disposition"] as? String) {
                    ...
                    requestPath = requestPath.appending("/tmp.AggregateAPIClient.\(UUID().uuidString)")
                }
    ...
    open func buildHeaders() -> [String: String] {
        ...
        for (key, value) in AggregateAPIClient.customHeaders {
            httpHeaders[key] = value
        }
        return httpHeaders
    }
